...
allcountBaseModule.provider("lcApi", function () {
    ...
    this.$get = ["$http", "$q", function ($http, $q) {
        ...
        service.getFieldDescriptions = function (entityCrudId, isGrid, successCallback) {
            ...
            var httpPromise = $http.get(entityUrl(castToEntityCrudId(entityCrudId), "/field-descriptions", {isGrid: isGrid}), {cache: lcApiDescriptionCaching})
                .then(getJson).then(function (descriptions) {
